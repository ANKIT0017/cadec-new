...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Phone",
      details: ["+91 11 2XXX XXXX", "+91 98XXX XXXXX (Student Coordinator)"],
    },
    {
      icon: Mail,
      title: "Email",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              Get in touch with us for any questions, suggestions, or
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Need to reach a specific team member? Here are their direct
              contact details.
            </p>
          </div>
